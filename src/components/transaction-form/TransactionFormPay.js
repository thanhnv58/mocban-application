...
class TransactionFormPay extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit = formData => {
    ...
    addTransaction(TransactionType.PAY, {
      id: generateId(),
      name: txtName,
...
const form = reduxForm({
  form: "ADD_TRANSACTION_PAY_FORM",
  validate
});

export default compose(withMyStyle, connectRedux, form)(TransactionFormPay);
